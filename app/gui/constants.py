from app.genetic.constants import POPULATION_SIZE, GENERATIONS, MAX_TRAIN_DEPTH, CROSSOVER_PCT, MUTATION_PCT
from app.game.constants import Color, Piece, GameEnd
#GUI####################################################################################################################
...
SLIDER_CIRCLE = 'app/assets/slider_circle.svg'

DEFAULT_FONT = 'app/assets/SpecialElite-Regular.ttf'
DEFAULT_TEXT_COLOR = (0,0,0)

PIECE_IMAGES = {
    (Piece.PAWN, Color.WHITE) : 'app/assets/white_pawn.svg',
    (Piece.PAWN, Color.BLACK) : 'app/assets/black_pawn.svg',
    (Piece.KING, Color.WHITE) : 'app/assets/white_king.svg',
    (Piece.KING, Color.BLACK) : 'app/assets/black_king.svg',
}

POSSIBLE_MOVE_IMG = 'app/assets/possible_move.svg'
BEST_TILE_IMG = 'app/assets/best_tile.svg'
...
TILE_BACKGROUND = 'app/assets/black_tile.svg'
...
GAME_CONTROL_BUTTON_IMAGES = ['app/assets/left_arrow.svg',
                              'app/assets/right_arrow.svg',
                              'app/assets/restart_button.svg']

LEFT_ARROW_IMAGE = 'app/assets/left_arrow.svg'
RIGHT_ARROW_IMAGE = 'app/assets/right_arrow.svg'
RESTART_ARROW_IMAGE = 'app/assets/restart_button.svg'

MENU_IMAGE = 'app/assets/menu.png'
...
CHECKED_CHECKBOX_BACKGROUND =  'app/assets/black_tile.svg'
