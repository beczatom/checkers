...
tested_moves = [
    ...
    Move(Color.BLACK, (BitBoard(0x00000004), BitBoard(0x00000200)), MoveType() | TAKE | Piece.KING,
         BitBoard(0x00000040)),
    ...
    Move(Color.BLACK, (BitBoard(0x00800000), BitBoard(0x40000000)), MoveType() | TAKE | Piece.PAWN,
         BitBoard(0x04000000)),
    Move(Color.WHITE, (BitBoard(0x00800000), BitBoard(0x40000000)), MoveType() | PROMOTION | TAKE | Piece.KING,
         BitBoard(0x04000000)),
]


@pytest.mark.parametrize('move, true_val', [
    (tested_moves[i], true_val) for i, true_val in
    enumerate([False, False, True, True, False, False, False, False, True, True])
])
...
@pytest.mark.parametrize('move, true_val', [
    (tested_moves[i], true_val) for i, true_val in
    enumerate([False, False, False, False, False, True, True, False, False, True])
])
